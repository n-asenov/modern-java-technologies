...
public interface AuthorshipDetector {
    ...
    /**
     * Returns the linguistic signature for the given input stream @mysteryText
    ...
    /**
     * 
     * Returns a non-negative real number indicating the similarity
     * between @firstSignature and @secondSignature. The calculation should be
     * done using the formula in the assignment.
     * 
     * The smaller the number, the more similar the signatures. Zero indicates
     * identical signatures.
     * 
     * @throws IllegalArgumentException if @firstSignature or @secondSignature
     *                                  is null
     * 
     */
