...
public class FoodDataApiClientTest {
    ...
    @Test
    public void testGetFoodDetailsWithCorrectFoodId()
        ...
        final FoodDetails actualfoodDetatils = apiClient.getFoodDetails(foodId);
        ...
        assertEquals(expectedValue, actualfoodDetatils.getLabelNutrients().getFat().getValue(),
                DELTA);
        assertEquals(expectedValue,
                actualfoodDetatils.getLabelNutrients().getCarbohydrates().getValue(), DELTA);
        assertEquals(expectedValue, actualfoodDetatils.getLabelNutrients().getCalories().getValue(),
                DELTA);
        assertEquals(expectedValue, actualfoodDetatils.getLabelNutrients().getFiber().getValue(),
                DELTA);
        assertEquals(expectedValue, actualfoodDetatils.getLabelNutrients().getProtein().getValue(),
                DELTA);
        assertEquals(foodId, actualfoodDetatils.getFdcId());
    }

    @Test(expected = InvalidFoodIdException.class)
    public void testGetFoodDetailsWithIncorrectFoodId()
            throws IOException, InterruptedException, InvalidFoodIdException {
    ...
    public void testSearchFoodWithNoMatchingFoodName()
            throws IOException, InterruptedException, NoMatchException {
