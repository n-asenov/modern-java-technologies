...
public class FoodDetailsStorageTest {
    ...
    @Test
    public void testLoadFoodDetailsDataFromInputWithOneObject() throws IOException, ClassNotFoundException {
        ...
        assertEquals(expectedFoodDetails.getLabelNutrients(), actualFoodDetails.getLabelNutrients());
    }
